...
export default Vue.extend({
  data () {
    return {
      isIE: false,
      commit: process.env.NUXT_ENV_CURRENT_GIT_HASH || 'dev'
    }
  },
  mounted () {
...
if (process.client) {
  ...
  ChannelIO('boot', {
    pluginKey: 'cd2d567f-b307-4bc9-9678-b52d94f22963'
  })
}
</script>
...
.neodgm {
  font-family: 'NeoDGM Pro', sans-serif;
}
.lv1 {
  font-family: 'Nexon Level1 Gothic', sans-serif;
}
